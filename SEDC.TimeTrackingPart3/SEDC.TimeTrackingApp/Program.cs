...
namespace SEDC.TimeTrackingApp
{
    class Program
    {
        ...
        public static ITrackService<Hobbies> _hobbies = new TrackService<Hobbies>();
        static void Main(string[] args)
        {
            ...
            _working.AddTrack(new Working()
            {
                Tittle = "Home",
                Description = "Working in home",
                Time = 90,
            ...
            _hobbies.AddTrack(new Hobbies()
            {
                Tittle = "Football",
                Description = "Play football",
                Time = 90,
                Hobbies = new List<HobbiesType>()
                {
                    HobbiesType.Football
                }
            });
            _hobbies.AddTrack(new Hobbies()
            {
